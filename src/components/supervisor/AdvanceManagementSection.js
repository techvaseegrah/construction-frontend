// construction/frontend/src/components/supervisor/AdvanceManagementSection.js
import React, { useEffect, useState, useContext } from 'react';
import API from '../../api/axios';
import { toast } from 'react-toastify';
import Table from '../common/Table';
import Modal from '../common/Modal';
import AdvanceForm from './AdvanceForm'; // Reusing existing form
...
const AdvanceManagementSection = ({ siteId }) => {
  ...
  const fetchAdvanceLogs = async () => {
    ...
    try {
      ...
      toast.error('Failed to load advance logs for this site.');
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-sm">
      ...
      <Table
        ...
        data={advanceLogs}
        emptyMessage="No advance payment logs found for this site with the selected criteria."
        renderRow={log => (
