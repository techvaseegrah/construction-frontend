// contract/frontend/src/pages/Admin/DailyActivityLogs.js
...
import ActivityLogForm from '../../components/supervisor/ActivityLogForm'; // Reusing form
...
const DailyActivityLogs = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-3xl font-bold text-gray-800 mb-6">Daily Activity Logs</h2>
...
export default DailyActivityLogs;