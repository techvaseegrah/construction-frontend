// contract/frontend/src/pages/Supervisor/LogRawMaterials.js
...
const LogRawMaterials = () => {
  ...
  useEffect(() => {
    fetchMySites();
    // Delay initial fetch of material logs until filters are potentially pre-filled
  ...
  useEffect(() => {
    // Refetch material logs whenever filters change, but not on initial load
