// construction/frontend/src/components/supervisor/MaterialLogSection.js
import React, { useEffect, useState, useContext } from 'react';
import API from '../../api/axios';
import { toast } from 'react-toastify';
import Table from '../common/Table';
import Modal from '../common/Modal';
import MaterialLogForm from './MaterialLogForm'; // Reusing existing form
...
const MaterialLogSection = ({ siteId }) => {
  ...
  const fetchMaterialLogs = async () => {
    ...
    try {
      ...
      toast.error('Failed to load material logs for this site.');
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-sm">
      ...
      <Table
        ...
        data={materialLogs}
        emptyMessage="No material logs found for this site with the selected criteria."
        renderRow={(log) => (
