// contract/frontend/src/pages/Admin/ReportGenerator.js
...
const ReportGenerator = () => {
  ...
  const generateReport = async (format) => {
    ...
    try {
      ...
      if (format === 'pdf') {
        ...
        link.href = url;
        link.setAttribute('download', 'contractor_report.pdf');
        document.body.appendChild(link);
        link.click();
        link.remove();
        toast.success('PDF report generated and downloaded!');
      } else if (format === 'excel') {
         // This path will be hit if the backend returns JSON indicating Excel is not implemented
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-3xl font-bold text-gray-800 mb-6">Report Generator</h2>
